...
Delegates all LLM calls to HSResearchService.
...
from app.services.common.ami_ai_research_service import HSResearchService
...
class ScoreAnalyzerService:
    ...
    - Call HSResearchService for AI scoring
    ...
    async def _analyze_country(self, country: Any, **_) -> bool:
        """Score the overall country-level HornScope assessment."""
    ...
    async def immediateSituation(self, country_id: int, **_) -> bool:
        ...
        question = f"""
        What are the most critical recent developments, emerging risks, structural weaknesses, and key strengths across HornScope domains in {country_Name}? Include insights on geopolitics, security, governance, economy, society, climate, corridors, and humanitarian resilience. Focus on cross-pillar patterns and high-impact information relevant for executive-level country assessment and situational awareness.
        """
